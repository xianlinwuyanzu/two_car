...
void ov7725_eagle_port_init()
{
    ...
    dma_portx2buff_init(CAMERA_DMA_CH, (void *)&PTB_B2_IN, (void *)ov7725_eagle_img_buff, PTC0, DMA_BYTE1, CAMERA_DMA_NUM);
...
//    disable_irq(PORTA_IRQn);                        //关闭PTA的中断
    ...
    port_init(PTC0, ALT1 | DMA_FALLING | PULLDOWN );         //PCLK

    port_init(PTC2, ALT1 | IRQ_RISING  | PULLDOWN | PF);     //场中断，上拉，上降沿触发中断，带滤波
...
//    }
 ...
 // enable_irq(PORTA_IRQn);
         DMA_IRQ_EN(CAMERA_DMA_CH);
        dma_repeat(CAMERA_DMA_CH, (void *)&PTB_B2_IN, (void *)ov7725_eagle_img_buff,CAMERA_DMA_NUM);
...
reg_s ov7725_eagle_reg[] =
{
    ...
    //寄存器，寄存器值次                 50帧               75帧           112帧            150帧
    {OV7725_COM4         , 0x41},  //    0xC1               0x41           0x81             0xC1
    ...
    {OV7725_SDE          , 0x04},
    {OV7725_BRIGHT       , 0x00},
    {OV7725_CNST         , 0x35},//{OV7725_CNST         , 0x40},//阀值    中午3C    34     下午 32
    {OV7725_SIGN         , 0x06},
    {OV7725_UVADJ0       , 0x11},
    {OV7725_UVADJ1       , 0x02},
